...
//   PIDUsage.sort(order("PID", "eventKey"));

//   PIDUsage.forEach(usageDataForPID => {
//     numberOfServerRequests += usageDataForPID.totalRequests;

//     if (previousPID !== usageDataForPID.PID) {
//       numberOfUsers += 1;
//       previousPID = usageDataForPID.PID;
//       writePIDUsageData()
//     }
//   });
...
//   function writePIDUsageData() {
//     usageData += `${usageID}\t${usageDataForPID.PID}\t${usageDataForPID.totalRequests}\r\n`;
//   }
// };
